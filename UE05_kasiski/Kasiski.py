...
class Kasiski:
    ...
    def crack_key(self, len: int) -> str:
        ...
        >>> verschluesselter_text = ""
        >>> k = Kasiski(verschluesselter_text)
        >>> k.crack_key(4)
        'fabian'
        >>> k.crack_key(7)
        'fabian'
...
if __name__ == "__main__":
    ...
    verschluesselter_text = v.encrypt(
